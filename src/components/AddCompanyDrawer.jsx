...
const AddCompanyDrawer = ({ fetchCompany }) => {
  ...
  useEffect(()=>{
    if(dataAddCompany?.length >0) fetchCompany()
  },[loadingAddCompany])
    ...
    <Drawer>
      ...
      <DrawerContent>
        ...
        <form className='flex gap-2 p-4 pb-0'>
          ...
          <Input type="file" accept="image/*" className="file:text-gray-500" placeholder="Company name" {...register("logo")} />
        ...
        {loadingAddCompany && <BarLoader className="mt-4" width={"100%"} color="#d73636" />}
